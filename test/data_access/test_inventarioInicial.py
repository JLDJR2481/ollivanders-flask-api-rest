...
def test_inventarioIncial():
    ...
    assert inventario[0] == {"_id": 1, "name": "+5 Dexterity Vest", "sell_in": 10, "quality": 20, "item_type": "NormalItem"}

    assert inventario[-1] == {"_id": 9, "name": "Conjured Mana Cake", "sell_in": 3, "quality": 6, "item_type": "Conjured"}
