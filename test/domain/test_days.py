...
dayFifteen = [
    NormalItem("+5 Dexterity Vest", -5, 0),
    AgedBrie("Aged Brie", -13, 28),
    NormalItem("Elixir of the Mongoose", -10, 0),
    Sulfuras("Sulfuras, Hand of Ragnaros", 0, 80),
    Sulfuras("Sulfuras, Hand of Ragnaros", -1, 80),
    Backstage("Backstage passes to a TAFKAL80ETC concert", 0, 50),
    Backstage("Backstage passes to a TAFKAL80ETC concert", -5, 0),
...
dayTwenty = [
    NormalItem("+5 Dexterity Vest", -10, 0),
    AgedBrie("Aged Brie", -18, 38),
    NormalItem("Elixir of the Mongoose", -15, 0),
    Sulfuras("Sulfuras, Hand of Ragnaros", 0, 80),
    Sulfuras("Sulfuras, Hand of Ragnaros", -1, 80),
    Backstage("Backstage passes to a TAFKAL80ETC concert", -5, 0),
    Backstage("Backstage passes to a TAFKAL80ETC concert", -10, 0),
...
dayTwentyfive = [
    NormalItem("+5 Dexterity Vest", -15, 0),
    AgedBrie("Aged Brie", -23, 48),
    NormalItem("Elixir of the Mongoose", -20, 0),
    Sulfuras("Sulfuras, Hand of Ragnaros", 0, 80),
    Sulfuras("Sulfuras, Hand of Ragnaros", -1, 80),
    Backstage("Backstage passes to a TAFKAL80ETC concert", -10, 0),
    Backstage("Backstage passes to a TAFKAL80ETC concert", -15, 0),
...
dayThirty = [
    NormalItem("+5 Dexterity Vest", -20, 0),
